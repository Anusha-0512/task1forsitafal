...
openai.api_key = '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'  # Replace with your OpenAI API key
...
def main():
    ...
    pdf_paths = ["D:/apps/sitafal_task1/document1.pdf", "D:/apps/sitafal_task1/document2.pdf"]  # Update with your PDF file paths
    ...
    # User query example
    user_query = "What are the main differences between product A and product B?"
